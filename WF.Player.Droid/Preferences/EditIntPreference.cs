// <copyright file="EditIntPreference.cs" company="Wherigo Foundation">
...
namespace WF.Player.Droid.Preferences
{
	...
	public class EditIntPreference : EditTextPreference
	{
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="WF.Player.Preferences.EditIntPreference"/> class.
		/// </summary>
		...
		protected override string GetPersistedString(string defaultReturnValue)
		{
			if (sharedPreferences.Contains(this.Key))
			{
				...
				int intValue = sharedPreferences.GetInt(this.Key, Convert.ToInt32(defaultReturnValue));
