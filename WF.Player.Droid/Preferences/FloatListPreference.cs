// <copyright file="FloatListPreference.cs" company="Wherigo Foundation">
...
namespace WF.Player.Droid.Preferences
{
	...
	public class FloatListPreference : ListPreference
	{
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="WF.Player.Preferences.FloatListPreference"/> class.
		/// </summary>
		...
		protected override string GetPersistedString(string defaultReturnValue)
		{
			if (sharedPreferences.Contains(this.Key))
			{
				...
				float floatValue = sharedPreferences.GetFloat(Key, Convert.ToSingle(defaultReturnValue));
