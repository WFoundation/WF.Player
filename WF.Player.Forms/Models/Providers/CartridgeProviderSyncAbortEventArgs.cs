// <copyright file="CartridgeProviderSyncAbortEventArgs.cs" company="Wherigo Foundation">
...
namespace WF.Player.Models.Providers
{
	...
	/// <summary>
	/// Cartridge provider sync abort event arguments.
	/// </summary>
	public class CartridgeProviderSyncAbortEventArgs : EventArgs
	{
		/// <summary>
		/// Gets or sets a value indicating whether this instance has aborted because of a timeout.
		/// </summary>
