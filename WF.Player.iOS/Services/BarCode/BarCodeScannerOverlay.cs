// <copyright file="BarCodeScannerOverlay.cs" company="Wherigo Foundation">
...
namespace WF.Player.iOS.Services.BarCode
{
	...
	public class BarCodeScannerOverlay : UIView
	{
		public BarCodeScannerOverlay (CGRect frame, string topText,
		...
		private void Initialize ()
		{
			...
			InvokeOnMainThread(delegate {
				...
				var button = new UIBarButtonItem(cancelText, UIBarButtonItemStyle.Plain, delegate { OnCancel(); });
				button.TintColor = App.Colors.Tint.ToUIColor();
				buttons.Add(button);
				if (hasTorch)
				{
					buttons.Add(new UIBarButtonItem(UIBarButtonSystemItem.FlexibleSpace));
					button = new UIBarButtonItem(flashText, UIBarButtonItemStyle.Plain, delegate { OnTorch(); });
					button.TintColor = App.Colors.Tint.ToUIColor();
					buttons.Add(button);
				}
				toolBar.Items = buttons.ToArray();
				toolBar.BarTintColor = App.Colors.Bar.ToUIColor();
